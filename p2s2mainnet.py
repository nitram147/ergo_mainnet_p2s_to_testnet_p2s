...
# /* +-----------------------------------------------------------+ */
# /* | Ergo Testnet P2S Address to Mainnet P2S Address Converter | */
# /* |                      p2s2mainnet.py                       | */
...
def print_usage(binary_name):
	...
	print("\tWhere [address] is testnet P2S adress such as Ms7smJwLGbUAjuWQ")
...
if input_decoded[0] != (testnet_prefix + p2s_address_type):
	print("Input should be Testnet P2S address")
	sys.exit(1)

#change prefix from testnet to mainnet
